...
import { SelectGroupState, SelectGrupItems } from '../../pages/IndividualWorkout';
...
export default function SelectGroup({ state, onCriteriaChange, selectGrupItems}:SelectGroup) {
  const handleSelectChange = useCallback((ev, item )=>{
