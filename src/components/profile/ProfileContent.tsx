...
import { Avatar, Box, Button, Divider, IconButton, ListItemIcon, Menu, MenuItem, Rating, styled, Tooltip, Typography } from '@mui/material';
...
const handleClick = () => {
  ...
  return workout? (
    ...
    <Box>
       <Button sx={{left:'80%', top:'5%'}}  variant="outlined">Выйти</Button>
    <MyBox>
